...
so verify a failure manually before removing a link. Note from
`CONTRIBUTING.md`: URLs marked with `*` are temporarily unavailable and should
not be deleted without confirming they have permanently expired.
