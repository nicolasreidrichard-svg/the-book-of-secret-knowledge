...
- Primary editable file: `README.md` (single, large table of contents + entries).
- Other tracked files: `LICENSE.md`, `static/img/*` (preview images), `.github/` meta files (`CONTRIBUTING.md`, `CODE_OF_CONDUCT.md`, `FUNDING.yml`).
...
- PR description: one-line summary; explain the problem and proposed solution.
- A URL marked `*` is temporarily unavailable — do not delete it without confirming permanent expiry (see `README.md`, "Contributing" section).
- Quality bar (from `README.md`): "This repository is not meant to contain everything but only good quality stuff."
